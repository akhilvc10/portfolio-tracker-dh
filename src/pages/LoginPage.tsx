...
export default function LoginPage() {
	return (
		<>
			<div className="container font-primary relative h-screen flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
				...
				<div className="h-full">
					<div className="mx-auto flex w-full h-full flex-col justify-center space-y-6 sm:w-[350px]">
						<Logo classNames="items-center justify-center mb-10 md:hidden" />
